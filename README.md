...
Esta aplicación en Java se conecta a una base de datos PostgreSQL para mostrar los puntos acumulados por los constructores en carreras de Fórmula 1. Utiliza Swing para crear una interfaz gráfica que permite seleccionar el año de la carrera y ver los puntos totales de los constructores en una tabla.

## Características

- Conexión a una base de datos PostgreSQL para obtener datos de puntos de los constructores.
- Interfaz gráfica con un combo box para seleccionar el año de la carrera.
- Tabla para mostrar los nombres de los constructores y sus puntos totales.
...
![image](https://github.com/user-attachments/assets/348a24e3-f684-42f0-819f-5294992ba3db)

![image](https://github.com/user-attachments/assets/bfab0cf4-6b05-4906-85cd-efdf0dfda7f7)
